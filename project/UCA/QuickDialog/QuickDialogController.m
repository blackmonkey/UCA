...
+ (UcaNavigationController*)controllerWithNavigationForRoot:(QRootElement *)root {
    return [[UcaNavigationController alloc] initWithRootViewController:[QuickDialogController
