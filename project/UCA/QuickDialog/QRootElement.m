...
- (QElement *)getElementAtIndexPath:(NSIndexPath *)indexPath {
    QSection *section = [self getSectionForIndex:indexPath.section];
    if (!section || indexPath.row < 0 || indexPath.row >= [section.elements count]) {
        return nil;
    }
