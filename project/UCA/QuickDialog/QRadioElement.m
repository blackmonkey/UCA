...
- (UITableViewCell *)getCellForTableView:(QuickDialogTableView *)tableView controller:(QuickDialogController *)controller {
    ...
    if (_icons && _selected >= 0 && _selected <_icons.count) {
        selectedIcon = [_icons objectAtIndex:(NSUInteger) _selected];
    }
    ...
    if (selectedIcon) {
        ...
        [button setTitleColor:cell.textField.textColor forState:UIControlStateNormal];
        [button sizeToFit];
