...
//        FMResultSet *rs = (FMResultSet *)[rsInWrappedInATastyValueMeal pointerValue];
        FMResultSet *rs = [rsInWrappedInATastyValueMeal nonretainedObjectValue];
...
//    void (^block)(sqlite3_context *context, int argc, sqlite3_value **argv) = (__bridge id)sqlite3_user_data(context);
    void (^block)(sqlite3_context *context, int argc, sqlite3_value **argv) = CFTYPEREF_TO_ID(sqlite3_user_data(context));
#endif
...
//    sqlite3_create_function([self sqliteHandle], [name UTF8String], count, SQLITE_UTF8, (__bridge void*)b, &FMDBBlockSQLiteCallBackFunction, 0x00, 0x00);
    sqlite3_create_function([self sqliteHandle], [name UTF8String], count, SQLITE_UTF8, ID_TO_CFTYPEREF(b), &FMDBBlockSQLiteCallBackFunction, 0x00, 0x00);
#endif
}
